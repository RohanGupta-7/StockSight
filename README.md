...
1. Clone the repository in your local directory using the command `git clone https://github.com/RohanGupta-07/StockSight.git`
2. Change directory to cloned Repository `cd StockSight`
